...
module NeutrinoApi
  ...
  class HostReputationResponse < BaseModel
    ...
    # An array of objects for each DNSBL checked, with the following
    # keys:<ul><li>is-listed - true if listed, false if not</li><li>list-name -
    # the name of the DNSBL</li><li>list-host - the domain/hostname of the
    # DNSBL</li><li>list-rating - the list rating [1-3] with 1 being the best
    # rating and 3 the lowest rating</li><li>txt-record - the TXT record
    # returned for this listing (if listed)</li><li>return-code - the specific
    # return code for this listing (if listed)</li><li>response-time - the DNSBL

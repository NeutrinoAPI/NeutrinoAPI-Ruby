...
module NeutrinoApi
  ...
  class EmailVerifyResponse < BaseModel
    ...
    # The full email address (this could be different to the supplied address if
    # typos-fixed is true)
    # @return [String]
    attr_accessor :email
    ...
    # connection</li><li>unknown - sorry, we could not reliably determine the
    # real status of this address (this address may or may not exist)</li></ul>
    # @return [String]

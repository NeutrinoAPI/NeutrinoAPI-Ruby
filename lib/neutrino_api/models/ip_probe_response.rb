...
module NeutrinoApi
  ...
  class IPProbeResponse < BaseModel
    ...
    # The detected provider type, possible values are:<br/><ul><li>isp - IP
    # belongs to an internet service provider. This includes both mobile, home
    # and business internet providers</li><li>hosting - IP belongs to a hosting
    # company. This includes website hosting, cloud computing platforms and
    # colocation facilities</li><li>vpn - IP belongs to a VPN
    # provider</li><li>proxy - IP belongs to a proxy service. This includes
    # HTTP/SOCKS proxies and browser based proxies</li><li>university - IP
    # belongs to a university/college/campus</li><li>government - IP belongs to
    # a government department. This includes military
    # facilities</li><li>commercial - IP belongs to a commercial entity such as
    # a corporate headquarters or company office</li><li>unknown - could not
    # identify the provider type</li></ul>
    # @return [String]

...
module NeutrinoApi
  ...
  class PhoneValidateResponse < BaseModel
    ...
    # The predicted number type.<br/>Note: type detection is not possible in
    # some countries which have no predictable prefix pattern (you can use the
    # HLR Lookup API in these cases)<br/> Possible values
    # are:<br/><ul><li>mobile</li><li>fixed-line</li><li>premium-rate</li><li>to
    # ll-free</li><li>voip</li><li>unknown (use HLR lookup instead)</li></ul>
    # @return [String]
    attr_accessor :type

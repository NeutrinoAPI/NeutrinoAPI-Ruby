...
module NeutrinoApi
  ...
  class WWW < BaseController
    ...
    # executing any selectors or JavaScript
    ...
    # in the 'exec-results' response.<br/><br/>For your convenience you can also
    # use the following special shortcut functions:<br/><div
    # style='padding-left:32px; font-family:inherit;
    # font-size:inherit;'>sleep(seconds); Just wait/sleep for the specified
    # number of seconds.<br/>click('selector'); Click on the first element
    # matching the given selector.<br/>focus('selector'); Focus on the first
    # element matching the given selector.<br/>keys('characters'); Send the
    # specified keyboard characters. Use click() or focus() first to send keys
    # to a specific element.<br/>enter(); Send the Enter key.<br/>tab(); Send
    # the Tab key.<br/></div><br/>Example:<br/><div style='padding-left:32px;
    # font-family:inherit; font-size:inherit;'>[ "click('#button-id')",
    # "sleep(1)", "click('.field-class')", "keys('1234')", "enter()" ]</div>
    ...
    # possible values are:<br/><b>plain-text</b>: reduce the content to plain
    # text only (no HTML tags at all)<br/><br/><b>simple-text</b>: allow only
    # very basic text formatting tags like b, em, i, strong,
    # u<br/><br/><b>basic-html</b>: allow advanced text formatting and hyper
    # links<br/><br/><b>basic-html-with-images</b>: same as basic html but also
    # allows image tags<br/><br/><b>advanced-html</b>: same as basic html with
    # images but also allows many more common HTML tags like table, ul, dl,
    # pre<br/>
